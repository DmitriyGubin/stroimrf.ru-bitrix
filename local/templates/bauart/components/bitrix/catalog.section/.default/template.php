...
<!-- <div class="form_houses">
	<div class="houses_list">
		...
		<div class="house_block">
			<div>
				<img src="img/30.png">
				<h2>Коттедж «Тростен»</h2>
				<p>
					Идеальное соотношение пространства, уюта, материалов и цены. Коттедж площадью 98 кв.м. 
			...
			<button class="buttonn modify_butt_houses_list">Подробнее</button>
		</div>
	</div>
</div> -->
